...
@export var mirror_offset:Vector3 = Vector3(0,0,0)
...
func _process(delta:float)->void:
	...
	var mirror_transform:Transform3D = get_mirror_transform((mirror_normal+mirror_offset).normalized(), mirror_quad.global_position)
	...
	#camera_to_mirror_offset += mirror_offset
